"""
Shared helpers and utilities for E2E query tests.
Contains validation logic, helper functions, and constants used across all test categories.
"""
...
def print_report(report: dict):
    """Print formatted report to console (implementation truncated for brevity)."""
